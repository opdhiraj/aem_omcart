...
//import static com.omcart.core.constant.AppConstants.TODO_THREAD_SLEEP_TIME;
...
//            LOGGER.info("{}: {} - activated", COMPONENT_NAME);
//            Runnable task = () -> {
//                try {
...
//                        LOGGER.info("{}: Trying to write TODO data in repository at: {}", LocalDateTime.now());
//                    }
