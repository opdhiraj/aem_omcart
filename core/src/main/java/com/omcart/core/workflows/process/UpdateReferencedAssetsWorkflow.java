package com.omcart.core.workflows.process;
...
import com.omcart.core.services.ReferencedAssetService;
...
import static com.omcart.core.constant.AppConstants.EQUALS;
import static com.omcart.core.constant.AppConstants.PROCESS_LABEL;
import static com.omcart.core.workflows.process.UpdateReferencedAssetsWorkflow.PROCESS_LABEL_VALUE;
...
public class UpdateReferencedAssetsWorkflow implements WorkflowProcess {
    ...
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap metaDataMap) {
        ...
        if (StringUtils.equals(payloadType, "JCR_PATH")) {
            ...
            LOGGER.debug("getUserID{} ", resourceResolver.getUserID());
            try {
