...
import com.omcart.core.models.Card;
...
public class CardImpl implements Card {
    ...
    protected static final String RESOURCE_TYPE = "omcart/components/content/card";
    ...
    protected void init() {
        ...
        LOGGER.info("resourceResolver  {}",resourceResolver.getUserID());
