...
@ObjectClassDefinition(name="omcart - Countries JSON configuration",
...
public @interface CountriesConfig {
    ...
    public String jsonPath() default "/content/omcart/us";
    ...
    public String authorsPath() default "/content/omcart/us";
}
